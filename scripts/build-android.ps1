...
try {
  ...
  Copy-Item -LiteralPath (Join-Path $env:LOCALAPPDATA 'Aura67Build\app\outputs\apk\debug\app-debug.apk') -Destination (Join-Path $releaseDir 'Aura67-v0.1.4-debug.apk') -Force
  Write-Host 'APK criado em releases\Aura67-v0.1.4-debug.apk'
} finally { Pop-Location }
