(function(){
  ...
  const targets=document.querySelectorAll('.welcome-panel,.next-victory,.metrics-grid,.evolution-panel,.dashboard-grid,.trajectory-message,.ranking-hero,.ranking-layout,.habits-hero,.mission-strip,.habits-toolbar,.community-center,.projects-hero,.projects-workspace,.identity-hero,.identity-card,.chat-shell');
