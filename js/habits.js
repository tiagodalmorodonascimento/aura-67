...
async function completeHabit(actionId) {
  ...
  if (error) { if(button)button.disabled=false; showToast(error.message.includes('já concluiu')?'Esta ação já foi concluída hoje.':'Não foi possível concluir a ação.'); return; }
